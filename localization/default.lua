return {
	misc = {
		...
		dictionary = {
			...
			csau_ach_rare_1 = "Bronze",
			csau_ach_rare_2 = "Silver",
			csau_ach_rare_3 = "Gold",
			csau_ach_rare_4 = "Vine",
	...
	descriptions = {
		Achievements = {
			...
			ach_csau_high_kerosene = {
				name = "Throw Another on the Fire",
				text = {
					"Get {C:attention}#1#{} to",
					"{C:chips}+200{} Chips"
				},
			},
			ach_csau_high_supper = {
				name = "Shoutouts to SupperMarioBroth",
				text = {
					"Trigger {C:attention}#1#{}",
					"{C:attention}#2#{} times in one hand"
				},
			},
			ach_csau_three_pepsecret = {
				name = "Secret Hoppin'",
				text = {
					"Use {C:attention}#1#{} on",
					"{C:attention}#2#{} unique {C:dark_edition}Secret Hands{}",
					"in one run"
				},
			},
			ach_csau_activate_red = {
				name = "Red-Blooded Italian",
				text = {
					"Activate",
					"{C:attention}#1#{}"
				},
			},
			ach_csau_activate_claus = {
				name = "16-Hit Combo",
				text = {
					"Play a {C:attention}#1# Steel Card{}",
					"hand with {C:attention}#2#{}"
				},
			},
			ach_csau_early_reyn = {
				name = "Reyn Time",
			...
			ach_csau_high_muppet = {
				name = "Could Become a Habit",
				text = {
					"Scale {C:attention}#1#{}",
					"to {X:mult,C:white}X#2#{} Mult"
				},
			},
			ach_csau_high_dontmind = {
				name = "Hmmm, What To Play...",
				text = {
					"Get {C:attention}High Card{}",
					"to {C:planet}Level #1#{}",
					"with {C:attention}#2#{}",
					"or {C:attention}#3#{}"
				},
		...
		Joker = {
			...
			j_csau_disturbedjoker = {
				...
				text = {
					"Increase draw limit by",
					"{C:attention}+1{} each {C:mult}discard{}",
				},
				unlock = {
			...
			j_csau_speedjoker = {
				...
				text = {
					"Increase draw limit by",
					"{C:attention}+1{} each {C:chips}hand{}",
				},
				unlock = {
		...
		VHS = {
			...
			c_csau_sew_plural = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#1#{} Jokers"
					}
				},
			},
			c_csau_shakma = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#1#{} {C:green}Chance"
					}
				},
			},
			c_csau_shakma_plural = {
				name = "Shakma",
				text = {
					{
						"While {C:attention}playing{}, always",
			...
			c_csau_exploding = {
				...
				text = {
					{
						"While {C:attention}playing{}, turn all but one {C:blue}Hand",
			...
			c_csau_exploding_plural = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#1#{} Roundz"
					}
				},
			},
			c_csau_choppingmall = {
			...
			c_csau_roar = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#1#{} Draw"
					}
				},
			},
			c_csau_roar_plural = {
			...
			c_csau_nukie = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#3#{} Wheel"
					}
				},
			},
			c_csau_nukie_plural = {
			...
			c_csau_streetsmarts = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#2#{} final hand"
					}
				},
			},
			c_csau_streetsmarts_plural = {
				name = "Street Smarts",
				text = {
					{
						"While {C:attention}playing{}, {C:mult}+#1#{} Mult",
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#2#{} final hands"
					}
				},
			},
			c_csau_devilstory = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#2#{} Card"
					}
				},
			},
			c_csau_devilstory_plural = {
				name = "Devil Story",
				text = {
					{
						"While {C:attention}playing{}, each played",
			...
			c_csau_sos = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#4#{} Hand"
					}
				},
			},
			c_csau_sos_plural = {
			...
			c_csau_miami = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#2#{} Draw"
					}
				},
			},
			c_csau_miami_plural = {
			...
			c_csau_spacecop = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#1# {C:planet}Planet"
					}
				},
			},
			c_csau_spacecop_plural = {
				name = "Space Cop",
				text = {
					{
						"While {C:attention}playing{}, {C:planet}Planet Cards{}",
			...
			c_csau_ritf = {
				...
				text = {
					...
					"{C:vhs}Running Time{} of {C:attention}#1#{} Hand, each card that",
			...
			c_csau_suburbansasquatch_plural = {
				name = "Suburban Sasquatch",
				text = {
					{
						"While {C:attention}playing{}, each scoring",
			...
			c_csau_donbeveridge = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#1#{} Trigger"
					}
				},
			},
			c_csau_donbeveridge_plural = {
				name = {
					"Don Beveridge",
					"{s:0.9}Customerization Seminar{}",
				},
			...
			c_csau_alienpi = {
				...
				text = {
					...
					{
						"{C:vhs}Running Time{}: {C:attention}#5#{} card"
					}
				},
			},
			c_csau_alienpi_plural = {
				name = "Alien Private Eye",
				text = {
					{
						"While {C:attention}playing{}, scoring cards give",
